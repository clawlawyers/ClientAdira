...
const Login = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-screen relative p-2">
      {/* <div className="w-full h-full flex justify-center absolute py-2">
        <img className="" src={aiIcon} />
      </div> */}
      <div
        className="flex flex-col h-screen w-full  z-20 p-4 gap-3 bg-black bg-opacity-80 rounded-lg"
